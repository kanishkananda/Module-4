...
2. Define a dictionary with key-value pairs.
   Sort by Keys:
3. Use sorted(dictionary.items())
4. Convert the result to a dictionary using dict()
   Sort by Values:
5. Use sorted(dictionary.items(), key=lambda item: item[1])
6. Convert the result to a dictionary using dict()
7. Display the original and sorted dictionaries.
8. End the program.
...
```
## Output
<img width="486" height="221" alt="image" src="https://github.com/user-attachments/assets/3c132406-5b37-4ae6-9b50-947f3b38d6fa" />
